...
[運用AI技術判別精細動作之早期遲緩篩檢系統介紹影片]([https://youtu.be/uGfGr5dzklI?si=zy6J9WrYJ886j5G3](https://www.youtube.com/watch?v=FlGjlvIecec&feature=youtu.be))
...
MySQL 紀錄單次與縱向表現，便於後續轉介與追蹤（目前資料庫與後端服務部署於實驗室 Mac mini M2 Pro，並透過 Tailscale 進行外網連線）
...
- **後端主機：** Flask 與 MySQL 部署在實驗室 Mac mini M2 Pro，外部連線透過 Tailscale 轉成可訪問的位址。
...
- **資料庫／後端主機：** MySQL 8.0+（部署主機：實驗室 Mac mini M2 Pro，透過 Tailscale 提供外網連線）
